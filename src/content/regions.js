...
export const POI_TYPES = {
  ...
  supply: {
    ...
    color: "#7cc36b",
    danger: 2,
    desc: "废弃的物资补给站,还有不少存货。",
    rewards: { food: [4, 8], water: [4, 8], scrap: [5, 10], parts: [1, 4] },
  },
  lab: {
    type: "lab",
    name: "实验室",
    ...
    color: "#9b7bd4",
    danger: 3,
    desc: "核战前的秘密实验室,藏着稀有材料。",
    rewards: { parts: [4, 9], meds: [3, 7], scrap: [3, 8], power: [1, 4] },
  },
};
...
const MAP_DEFS = [
  ...
  },
  {
    ...
    bgGradBot: "#121a20",
    accent: "#5b9bd5",
    gridLineColor: "rgba(60,100,140,0.12)",
    entry: { gx: 0, gy: 5 },
    unlock: { type: "discover", mapId: "town", count: 2 },
    pois: [
      { type: "supply", gx: 5, gy: 2 },
      { type: "cache", gx: 8, gy: 5 },
      { type: "supply", gx: 3, gy: 6 },
    ],
    eventRate: 0.65,
  },
  {
    ...
    bgGradBot: "#181216",
    accent: "#9b7bd4",
    gridLineColor: "rgba(140,100,170,0.12)",
    entry: { gx: 0, gy: 6 },
    unlock: { type: "compound", conditions: [
      { type: "resource", res: "parts", amount: 50 },
      { type: "discover", mapId: "hospital", count: 2 },
    ] },
    pois: [
      { type: "lab", gx: 5, gy: 3 },
      { type: "lab", gx: 9, gy: 6 },
  ...
  },
  {
    ...
    name: "核战地堡",
    icon: "🏚️",
    desc: "传说中核战前的地下堡垒,最危险也最富饶。只有经验丰富的避难所能找到。",
    gridW: 16,
    gridH: 13,
    bgColor: "#28201a",
    bgGradTop: "#302820",
    bgGradBot: "#1c1610",
    accent: "#e0c14a",
    gridLineColor: "rgba(180,150,80,0.12)",
    entry: { gx: 0, gy: 6 },
    unlock: { type: "compound", conditions: [
      { type: "expeditions", count: 8 },
      { type: "discover", mapId: "lab", count: 1 },
    ] },
    pois: [
      { type: "military", gx: 6, gy: 4 },
      { type: "lab", gx: 10, gy: 7 },
      { type: "supply", gx: 3, gy: 2 },
      { type: "cache", gx: 8, gy: 9 },
    ],
    eventRate: 0.75,
  },
];
